...
<script type="text/javascript">
	$(function() {
		...
		$("#vcodeImg").click(
				function() {
					this.src = "CpachaServlet?method=GetRegisterVCode&t="
							+ new Date().getTime();
				});
		...
		$("#submitBtn")
				.click(
						function() {
							...
							if(repassword==''){
								$.messager.alert("消息提醒", "请确认密码!", "warning");
								return;
							}
							if(vcode==''){
							...
							$
									.ajax({
										type : "post",
										url : "LoginServlet?method=registerAction",
										data : data,
										...
										success : function(data) {
											if("error"==data.type){
												...
												alert("注册成功");
												window.location.href = "LoginServlet?method=toLogin";
											}
										}
			...
			<form id="form" class="form form-horizontal" method="post">
				...
				<div class="row cl">
					<div class="formControls col-8 col-offset-3">
						<input class="input-text size-L" id="vcode" name="vcode" type="text"
							placeholder="请输入验证码" style="width: 200px;"> <img
							title="点击图片切换验证码" id="vcodeImg"
							src="CpachaServlet?method=GetRegisterVCode">
					</div>
				</div>
				...
				<div class="row">
					<div class="formControls col-8 col-offset-3">
						<input id="submitBtn" type="button"
							...
							value="&nbsp;注&nbsp;&nbsp;&nbsp;&nbsp;册&nbsp;"> <a
							href="LoginServlet?method=toLogin"
