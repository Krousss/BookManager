	...
	$(function() {	
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "删除用户前请确认用户没有借阅信息，否则借阅信息显示将会发生异常", function(r){
            		if(r){
            			$.ajax({
							type: "post",
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "UserServlet?method=editUserBymanager&t="+new Date().getTime(),
...
<body>
	...
	<!-- 工具栏 -->
		...
		<div style="margin-left: 10px;">
			姓名：<input id="search-name" class="easyui-textbox" /><a
	...
	<div id="addDialog" style="padding: 10px">  
    	<form id="addForm" method="post" action="UserServlet?method=addUser">
			<table cellpadding="8">
				<tr>
					<td>用户名:</td>
				...
				<tr>
					<td>状态</td>
					<td><select id="add_status" class="easyui-combobox"
						data-options="editable: false, panelHeight: 50, width: 200, height: 30"
						name="status">
	...
	<div id="editDialog" style="padding: 10px"> 
    	<form id="editForm" method="post">
	    	...
	    	<table cellpadding="8">
				...
				<tr>
					<td>状态</td>
					<td><select id="edit_status" class="easyui-combobox"
						data-options="editable: false, panelHeight: 50, width: 200, height: 30"
						name="status">
							<option value="1">正常</option>
							<option value="0">禁用</option>
